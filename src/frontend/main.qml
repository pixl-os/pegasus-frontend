...
Window {
    ...
    ListModel {
        ...
        ListElement { icon: "\uf2ca"; keywords: "ps5,playstation 5,dualsense,wireless controller,Sony Interactive Entertainment Wireless Controller"; type:"controller"; iconfont: "awesome"; layout: "ps5"} // add wireless controller as usual PS name used by Sony
