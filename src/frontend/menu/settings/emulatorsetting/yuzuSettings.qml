...
//    anchors.fill: parent
    ...
    property string prefix : game ? "override.yuzu" : "yuzu"
    //to manage better title in screen ScreenHeader (if we want to change it during loading)
    property string titleHeader: game ? game.title +  " > Yuzu" :
        (system ? system.name + " > Yuzu" :
         qsTr("Advanced emulators settings > Yuzu") + api.tr)
