...
//    anchors.fill: parent
    ...
    property string prefix : game ? "override.suyu" : "suyu"
    //to manage better title in screen ScreenHeader (if we want to change it during loading)
    property string titleHeader: game ? game.title +  " > Suyu" :
        (system ? system.name + " > Suyu" :
         qsTr("Advanced emulators settings > Suyu") + api.tr)
        ...
        FocusScope {
            ...
            Column {
                ...
                MultivalueOption {
                    id: optScalingFilter
                    //property to manage parameter name
                    property string parameterName : prefix + ".scaling.filter"
                ...
                SliderOption {
                    id: optFsrSharpening
                    //property to manage parameter name
                    property string parameterName : prefix + ".fsr.sharpening"
                ...
                ToggleOption {
                    ...
                    checked: api.internal.recalbox.getBoolParameter(prefix + ".async.shader")
                    onCheckedChanged: api.internal.recalbox.setBoolParameter(prefix + ".async.shader",checked);
                    onFocusChanged: container.onFocus(this)
                ...
                ToggleOption {
                    ...
                    checked: api.internal.recalbox.getBoolParameter(prefix + ".extended.memory")
                    onCheckedChanged: api.internal.recalbox.setBoolParameter(prefix + ".extended.memory",checked);
                    onFocusChanged: container.onFocus(this)
                ...
                ToggleOption {
                    ...
                    checked: api.internal.recalbox.getBoolParameter(prefix + ".docked.mode")
                    onCheckedChanged: api.internal.recalbox.setBoolParameter(prefix + ".docked.mode",checked);
                    onFocusChanged: container.onFocus(this)
                }
                Item {
                    width: parent.width
