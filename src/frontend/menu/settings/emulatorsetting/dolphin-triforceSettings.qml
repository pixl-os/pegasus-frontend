...
//    anchors.fill: parent
    ...
    property string prefix : game ? "override.dolphin-triforce" : "dolphin-triforce"

    //to manage better title in screen ScreenHeader (if we want to change it during loading)
    property string titleHeader : game ? game.title +  " > Dolphin Triforce" :
                                  (system ? system.name + " > Dolphin Triforce" :
                                   qsTr("Advanced emulators settings > Dolphin Triforce") + api.tr)
