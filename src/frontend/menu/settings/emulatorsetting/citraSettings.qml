...
//    anchors.fill: parent
    ...
    property string prefix : game ? "override.citra" : "citra"

    //to manage better title in screen ScreenHeader (if we want to change it during loading)
    property string titleHeader : game ? game.title +  " > Citra-emu" :
                                  (system ? system.name + " > Citra-emu" :
                                         qsTr("Advanced emulators settings > Citra-emu") + api.tr)
        ...
        FocusScope {
            ...
            Column {
                ...
                ToggleOption {
                    ...
                    checked: api.internal.recalbox.getBoolParameter(prefix + ".bottom.screen.on.second.display",false)
                    onCheckedChanged: {
                        api.internal.recalbox.setBoolParameter(prefix + ".bottom.screen.on.second.display",checked);
                    }
                ...
                MultivalueOption {
                    ...
                    //property to manage parameter name
                    property string parameterName : prefix + ".screens.layout"
