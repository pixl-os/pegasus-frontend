...
FocusScope {
    ...
    ScreenHeader {
        id: header
        text: qsTr("Advanced emulators settings > Suyu") + api.tr
        z: 2
    }
    Flickable {
        id: container
        ...
        FocusScope {
            ...
            Column {
                ...
                MultivalueOption {
                    ...
                    property string parameterName : "suyu.resolution"
                ...
                MultivalueOption {
                    id: optScalingFilter
                    //property to manage parameter name
                    property string parameterName : "suyu.scaling.filter"
                ...
                SliderOption {
                    id: optFsrSharpening
                    //property to manage parameter name
                    property string parameterName : "suyu.fsr.sharpening"
                ...
                MultivalueOption {
                    id: optVsync
                    //property to manage parameter name
                    property string parameterName : "suyu.vsync"
                ...
                ToggleOption {
                    ...
                    checked: api.internal.recalbox.getBoolParameter("suyu.async.shader")
                    onCheckedChanged: api.internal.recalbox.setBoolParameter("suyu.async.shader",checked);
                    onFocusChanged: container.onFocus(this)
                ...
                ToggleOption {
                    ...
                    checked: api.internal.recalbox.getBoolParameter("suyu.extended.memory")
                    onCheckedChanged: api.internal.recalbox.setBoolParameter("suyu.extended.memory",checked);
                    onFocusChanged: container.onFocus(this)
                ...
                ToggleOption {
                    ...
                    checked: api.internal.recalbox.getBoolParameter("suyu.docked.mode")
                    onCheckedChanged: api.internal.recalbox.setBoolParameter("suyu.docked.mode",checked);
                    onFocusChanged: container.onFocus(this)
                }
                Item {
                    width: parent.width
