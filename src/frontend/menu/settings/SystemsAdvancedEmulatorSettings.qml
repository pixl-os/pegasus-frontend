...
FocusScope {
    ...
    SystemsAdvancedEmulatorMain {
        id: main
        focus: true
        anchors.right: parent.right

        onClose: root.close()
        onOpenSystemsEmulatorConfiguration: {
            console.log("onOpenSystemsEmulatorConfiguration");
            root.openScreenWithSystem("SystemsEmulatorConfiguration.qml", system);
        }
    }
    Loader {
        id: modal
