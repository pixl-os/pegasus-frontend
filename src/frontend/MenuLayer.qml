...
FocusScope {
    ...
    Rectangle {
        ...
        Text {
            ...
            text: api.internal.meta.buildName + "  BUILD: " + api.internal.meta.buildDate + " " + api.internal.meta.buildVersion  + " GIT: " + api.internal.meta.gitRevision + "," + api.internal.meta.gitDate
            color: "#eee"
